<%-- 
    ...
    Created on : Feb 16, 2020, 1:57:54 PM
    Author     : Bhuvana-PC
--%>
   ...
   <body class="clinic_version">
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
                                    ...
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&emsp;&nbsp;&nbsp;Specialization</strong></b></td>                                          
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;&nbsp;&emsp;&emsp;View Report</strong></b>&emsp;</td>   
         </tr>
                               <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
...
<%  
    try{
        String status="";
                        PreparedStatement ps=con.prepareStatement("select * from patient where doctor='"+id+"' ");
                        ResultSet rs=ps.executeQuery();
                                ...
                                <tr>
                                    ...
                                    <td align="center"><a style="color:green;font-weight: bold;" href="viewP.jsp?id=<%=rs.getString("id")%>" >&emsp;Click Here</a></td>
