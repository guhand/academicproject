<%-- 
    Document   : viewapp
    Created on : Feb 16, 2020, 11:36:11 AM
    Author     : Bhuvana-PC
--%>
...
<html lang="en">
   ...
   <body class="clinic_version">
    ...
    %>
               ...
               <div class="right-header">
                  <div class="header-info">
                     <div class="info-inner">
                        <span class="iconcont" style="font-size:25px;color: black;">Block Chain Based Implementation of Electronic Medical Health Record</span>	
                     </div>                     
                  </div>
               </div>
            </div>
      ...
      <hr class="hr1">
       <center><h1>View Patient Appointment</h1><br>
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
                                    ...
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;&nbsp;&emsp;Specialization</strong></b>&emsp;</td>                
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;Update & Store Data</strong></b>&emsp;</td>   
         </tr>
                               <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
        ...
        String status="";
                        ...
                        ResultSet rs=ps.executeQuery();
                                ...
                                <tr>
                                    ...
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;&nbsp;<%=rs.getString("spe")%></td>
                                    <%
                                    if(status.equals("Initial"))
                                    {
                                    %>                                    
                                    <td align="center"><a style="color:green;font-weight: bold;" href="updateapp.jsp?id=<%=rs.getString("id")%>" >Click Here</a></td>
                                    <%}
                                    else
                                    {
                                    %>                                    
                                    <td align="center"><a style="color:red;font-weight: bold;" >&nbsp;&nbsp;Already Updated</a>&emsp;</td>
                                    <%}%>
