<%-- 
    Document   : plogin
    Created on : Feb 16, 2020, 10:46:11 AM
    Author     : Bhuvana-PC
--%>
               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a class="active" data-scroll href="plogin.jsp">Patient Login</a></li>
                     </ul>
                  </div>
               </nav>
               <div class="serch-bar">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <input type="text" id="name" placeholder="Your Username" name="name" required="" />
                                    </div>
                                 </div>
                              </div>
                               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <input type="password" name="password" id="pass" placeholder="Your Mobile Number is Password" required="" />
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
